...
# -*- coding: utf-8 -*-
#
# predeval documentation build configuration file.
...
with open('../../predeval/__init__.py', 'rb',
          encoding='utf-8') as f:
    version_lib = f.read()
...
html_theme_options = {
    ...
    'author_url': 'www.danvatterott.com',
    'twitter_id': '@dvatterott',
    'publish_date': datetime.datetime.now().date(),
    'years': datetime.datetime.now().year,
    'scm_name': 'Github',
    'scm_url': 'https://github.com/dvatterott/predeval',
    'ci_name': 'Travis',
    'ci_url': 'https://travis-ci.org/dvatterott/predeval',
    'issues_name': 'Github',
    'issues_url': 'https://github.com/dvatterott/predeval/issues',
    'releases_repos': [
        ('Pypi',
         'https://pypi.python.org/pypi/predeval')],
...
texinfo_documents = [
    (master_doc, project, '%s Documentation' % project,
     ','.join(authors), project, 'A library for comparing a model's output to the expected output from the model.',
     'Miscellaneous'),
]
